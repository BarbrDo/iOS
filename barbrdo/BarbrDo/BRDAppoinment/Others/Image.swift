...
//  Copyright (c) 2017 Vishwajeet Kumar. All rights reserved.
//
...
extension UIImageView {
    ...
    public func circularImageView(_ color: UIColor = .white) -> UIImageView {
        DispatchQueue.main.async {
    ...
    public func boarderColor(_ color: UIColor = .black) -> UIImageView {
        DispatchQueue.main.async {
