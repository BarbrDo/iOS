//
//  BRD_Customer_NotificationVC.swift
//  BarbrDo
//
...
let KBRD_Customer_NotificationVC_StoryboardID = "BRD_Customer_NotificationVC_StoryboardID"

class BRD_Customer_NotificationVC: BRD_BaseViewController,UITableViewDelegate,UITableViewDataSource{
