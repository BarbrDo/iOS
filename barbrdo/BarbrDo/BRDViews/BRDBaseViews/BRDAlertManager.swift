...
class BRDAlertManager: Any {
    
    
    public typealias ButtonClickedResponse = (_ clickedIndex: Int) -> Void
    
    //MARK: ALERT VIEW
    open class func showOKAlert(_ type: UIAlertActionStyle = .default, withTitle title: String?, withMessage message: String?, onViewController vc: UIViewController, animatedly: Bool = true, presentationCompletionHandler: BlankBlock? = nil, returnBlock:@escaping ButtonClickedResponse) -> UIAlertController {
        return showAlertWithSimilarButtonsType(type, withTitle: title, withMessage: message, buttonTitles: ["OK"], onViewController: vc, animated: animatedly, presentationCompletionHandler: presentationCompletionHandler, returnBlock: returnBlock)
    }
    
    open class func showAlertWithSimilarButtonsType(_ type: UIAlertActionStyle = .default, withTitle title: String?, withMessage message: String?, buttonTitles:[String], onViewController vc: UIViewController, animated: Bool = true, presentationCompletionHandler: BlankBlock? = nil, returnBlock: @escaping ButtonClickedResponse) -> UIAlertController{
        ...
        for title in buttonTitles{
         ...
         return showAlert(withTitle: title, withMessage: message, buttons: actions, onViewController: vc, animatedly: animated, presentationCompletionHandler: presentationCompletionHandler, returnBlock: returnBlock)
    }
