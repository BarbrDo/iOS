...
class AfternoonBO: NSObject {
     ...
     */
    public class func modelsFromDictionaryArray(array:NSArray) -> [AfternoonBO]
    {
        var models:[AfternoonBO] = []
        for item in array
        {
            models.append(AfternoonBO(dictionary: item as! NSDictionary)!)
        }
        return models
    }
