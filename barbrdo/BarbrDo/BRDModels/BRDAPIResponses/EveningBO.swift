...
class EveningBO: NSObject {
     ...
     */
    public class func modelsFromDictionaryArray(array:NSArray) -> [EveningBO]
    {
        var models:[EveningBO] = []
        for item in array
        {
            models.append(EveningBO(dictionary: item as! NSDictionary)!)
        }
        return models
    }
