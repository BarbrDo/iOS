...
class ConfirmAppointmentBO: NSObject {
     ...
     */
    public class func modelsFromDictionaryArray(array:NSArray) -> [ConfirmAppointmentBO]
    {
        var models:[ConfirmAppointmentBO] = []
        for item in array
        {
            models.append(ConfirmAppointmentBO(dictionary: item as! NSDictionary)!)
        }
        return models
    }
    ...
    required public init?(dictionary: NSDictionary) {
        ...
        if (dictionary["barber_id"] != nil) { barber_id = BarberInfo(dictionary: dictionary["barber_id"] as! NSDictionary) }
        ...
        reach_in = dictionary["reach_in"] as? Int
