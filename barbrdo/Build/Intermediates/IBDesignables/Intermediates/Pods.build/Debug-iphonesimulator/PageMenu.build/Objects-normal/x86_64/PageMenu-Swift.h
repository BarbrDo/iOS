...
@interface CAPSPageMenu (SWIFT_EXTENSION(PageMenu)) <UIGestureRecognizerDelegate>
@end


@interface CAPSPageMenu (SWIFT_EXTENSION(PageMenu))
@end

@class UIScrollView;

@interface CAPSPageMenu (SWIFT_EXTENSION(PageMenu)) <UIScrollViewDelegate>
