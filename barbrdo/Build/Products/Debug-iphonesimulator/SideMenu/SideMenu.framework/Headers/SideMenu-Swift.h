...
+ (enum MenuPushStyle)menuPushStyle;
...
+ (double)menuAnimationCompleteGestureDuration;
...
+ (UIViewAnimationOptions)menuAnimationOptions;
...
+ (CGFloat)menuAnimationUsingSpringWithDamping;
...
+ (CGFloat)menuAnimationInitialSpringVelocity;
