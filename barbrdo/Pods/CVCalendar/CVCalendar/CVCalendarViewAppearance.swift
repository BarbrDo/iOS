...
public final class CVCalendarViewAppearance: NSObject {
    ...
    public var dayLabelWeekdayInTextColor: UIColor? = .blue
    public var dayLabelWeekdayOutTextColor: UIColor? = .gray
    public var dayLabelWeekdayHighlightedTextColor: UIColor? = .white
    public var dayLabelWeekdaySelectedTextColor: UIColor? = .lightGray
    ...
    public var dayLabelWeekdaySelectedBackgroundColor: UIColor? = UIColor.white //.colorFromCode(0x1D62F0)
